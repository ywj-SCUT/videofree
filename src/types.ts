...
export interface LiveChannel { id: string; name: string; group: string; url: string; logo?: string }
...
export interface LumenApi {
  ...
  importTvBox(config: unknown): Promise<{ importedSources: number; importedLives: number; settings: AppSettings }>;
