...
export const OPEN_CATALOG: MediaItem[] = [
  {
    ...
    title: 'Big Buck Bunny', poster: 'https://archive.org/services/img/BigBuckBunnyOfficialBlenderFoundationShortFilm720p30fps',
  ...
  },
  {
    ...
    title: 'Sintel', poster: 'https://archive.org/services/img/Sintel',
  ...
  },
  {
    ...
    title: 'Tears of Steel', poster: 'https://archive.org/services/img/Tears-of-Steel',
  ...
  },
  {
    ...
    title: 'Elephants Dream', poster: 'https://archive.org/services/img/ElephantsDream',
  ...
  },
  {
    ...
    title: 'AI 影像工作流演示', poster: 'https://archive.org/services/img/springopenmovie',
